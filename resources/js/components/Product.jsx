            ...
            <div className="details">
                ...
                <div className="big-img" style={{ position: "relative" }}>
                    ...
                    <div
                        ...
                        // Si no está disponible, pasamos 'undefined' a los eventos para que no hagan nada
                        onMouseMove={
                            product.available ? handleMouseMove : undefined
                        }
                        onMouseLeave={
                        ...
                        style={{
                            ...
                            // Aplicamos los filtros y el borde SOLO si NO está disponible
                            filter: product.available
                                ? "none"
                                : "grayscale(100%) contrast(4)",
                        }}
                ...
                <div className="box">
                    ...
                    <MDBBtn
                        tag={!product.available ? "button" : "a"}
                        href={
                            product.available ? product.seller_url : undefined
                        }
                        ...
                        style={{
                            ...
                            color: !product.available ? "#888" : "inherit", // Opcional: un color más tenue si está agotado
                    ...
                    >
                        <MDBIcon
                            // Cambiamos entre el icono de instagram o el de corazón roto
                            fas={!product.available}
                            fab={product.available}
                            icon={
                                !product.available
                                    ? "heart-broken"
                                    : "instagram"
